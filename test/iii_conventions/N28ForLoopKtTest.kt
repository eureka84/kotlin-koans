...
class N28ForLoopKtTest {
    ...
    fun testIterateOverDateRange() {
        ...
        assertEquals("Incorrect iteration over five nice spring dates", expectedDateRange, actualDateRange)
    }
    ...
    fun testIterateOverTheNewYear() {
        ...
        assertEquals("Incorrect iteration over the end of the year", expectedDateRange, actualDateRange)
    }
}